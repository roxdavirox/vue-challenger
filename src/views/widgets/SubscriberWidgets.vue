  ...
  <CRow>
    <CCol :xs="3">
      <CWidgetStatsA class="mb-4" color="primary">
        ...
        <template #title>Inscritos na semana</template>
        <template #action>
    ...
    <CCol :xs="3">
      <CWidgetStatsA class="mb-4" color="info">
        ...
        <template #title>Rematriculas</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
    ...
    <CCol :xs="3">
      <CWidgetStatsA class="mb-4" color="warning">
        ...
        <template #title>Conversão de inscritos</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
    ...
    <CCol :xs="3">
      <CWidgetStatsA class="mb-4" color="danger">
        ...
        <template #title>Total de inscritos</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
